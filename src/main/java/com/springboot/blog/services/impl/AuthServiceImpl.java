...
import com.springboot.blog.entities.UserEntity;
...
public class AuthServiceImpl implements IAuthService {
    ...
    public String register(RegisterDto registerDto) {
        ...
        // check for username or email exists in database
        if (userRepository.existsByUsername(registerDto.getUsername())
                || userRepository.existsByEmail(registerDto.getEmail())) {
            throw new BlogAPIException(HttpStatus.BAD_REQUEST, "Username or password is already exists!");
        }
